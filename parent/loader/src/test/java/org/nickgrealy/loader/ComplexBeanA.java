...
public class ComplexBeanA {
    ...
    public ComplexBeanA(Long id, String name, ComplexBeanA simple, ComplexBeanA simple2, Collection<ComplexBeanA> collection, List<ComplexBeanA> list, Set<ComplexBeanA> set) {
        this.id = id;
        this.name = name;
        this.simple = simple;
